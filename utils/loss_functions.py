...
def beta_schedule(epoch, total_epochs, max_beta=1.0, warmup_epochs=12):
    ...
    if epoch < warmup_epochs:
        ...
        # Reasonable stable beta for good latent regularization
        return max_beta * 1.8  # Reduced from 2.5
